...
## Machine readable version (Markdown) - 4.0b
...
- An example of a final specification version would be 4.0b.
...
The case-sensitive UTF-8 character field `achSFeFullVersion` contains the full version string of the specification used, for example `4.0b`.
...
- Create an `ISFe-list` sub-chunk with information: `SFty = "SFe-static"`, `SFvx = 4, 0, Final, 0, "4.0b"`, `flag` corresponding to features used in the bank.
