# SF-enhanced (SFe) specification

## Version 4.00.5 (draft specification) - August 2024
...
Draft specifications have version numbers in the format x.yy.zL, where x, y and z are numbers and L is a letter. In this case, the versioning works similarly to a final specification, but with these changes:
